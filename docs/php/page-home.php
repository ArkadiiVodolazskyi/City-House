					...
					?>
						<button
							...
							<svg width="60" height="90" viewBox="0 0 60 90" fill="none" xmlns="http://www.w3.org/2000/svg">
								<defs>
									<linearGradient id="marker_<?= $key + 1; ?>" x1="30" y1="90" x2="30" y2="0" gradientUnits="userSpaceOnUse">
										<stop stop-color="#19493E"/>
										<stop offset="1" stop-color="#C3E2DB"/>
									</linearGradient>
								</defs>
								<path d="M30 0C14.0072 0 0.996094 13.0112 0.996094 29.0039C0.996094 50.6869 26.7512 87.3367 27.8476 88.8863C28.3417 89.5848 29.1443 90 30 90C30.8557 90 31.6583 89.5848 32.1524 88.8863C33.2488 87.3367 59.0039 50.6869 59.0039 29.0039C59.0039 13.0112 45.9928 0 30 0Z" fill="url(#marker_<?= $key + 1; ?>)"/>
